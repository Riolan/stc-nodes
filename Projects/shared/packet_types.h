...
// --- Payload Structures (Informational - Actual packing/unpacking happens manually) ---
// Example structure for SUBTYPE_DETECTION payload:
...
// TOTAL: ~18 bytes (adjust based on included fields)
