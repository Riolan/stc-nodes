...
#include <Arduino.h>
#include <BLEDevice.h> // Use NimBLE if preferred: #include <NimBLEDevice.h>
#include <BLEUtils.h>
#include <BLEServer.h>
#include <BLE2902.h>
#include <queue>
#include <string> // Use std::string instead of Arduino String for potentially less fragmentation

// Forward declare necessary LoRa types if needed for function signatures
namespace lora {
    // Example: struct LoRaPacket; // If bt functions take LoRa packets directly
}

namespace bt {

    // BLE configuration (Consider making these const char* instead of #define)
